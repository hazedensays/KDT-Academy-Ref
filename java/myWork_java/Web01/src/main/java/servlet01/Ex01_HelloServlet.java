...
public class Ex01_HelloServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.print("<html><body>");
		out.print("<h2>** Hellloo Servlet **</h2>");
		out.print("<h2 style='color:blue;'>안녕하세요 ~~~</h2>");
		String name = "홍길동";		
		out.print("<h3> name= "+name+"</h3>");
		out.print("<h3>*Servlet의 장점 : Java Code가 매우 편리해짐</h3>");
		out.print("<h3>*Servlet의 단점 : View(Html..)작성이 매우 불편함</h3>");
		out.print("</body></html>");
	}
