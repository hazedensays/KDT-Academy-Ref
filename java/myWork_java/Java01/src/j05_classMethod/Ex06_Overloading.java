...
public class Ex06_Overloading {
	...
	public static void main(String[] args) {
		...
		System.out.println("** int - double => " + add(10, 20.123));
		System.out.println("** double - int => " + add(10.123, 20));
		System.out.println("** double - double => " + add(10.123, 20.123));
	}
